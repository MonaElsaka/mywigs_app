...
class syntchs extends StatefulWidget {
  const syntchs({ Key? key }) : super(key: key);

  @override
  _syntchsState createState() => _syntchsState();
}

class _syntchsState extends State<syntchs> {
                ...
                children:[
                  ...
                  Row(                             mainAxisAlignment: MainAxisAlignment.start,
                    ...
                    children: [
                      RaisedButton(
                        padding: EdgeInsets.all(10.0),
                        child: Column(children: [Text("pick image")],),
